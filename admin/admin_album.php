...
// Cek apakah user sudah login dan apakah mereka admin
...
// Ambil nama pengguna dari database untuk menampilkan di navbar
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="card mt-4 shadow-lg border-light">
          ...
          <div class="card-body">
            <form action="../config/aksi_admin_album.php" method="POST">
              <div class="mb-3">
          ...
          <div class="card-body">
            <table class="table table-bordered table-striped table-hover">
              ...
              <tbody>
                <?php
                $no = 1;
                // Menampilkan album dari semua user
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <!-- Tombol Edit -->
                      <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#edit<?php echo $data['id_album'] ?>">Edit</button>
                      <!-- Modal Edit -->
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="../config/aksi_admin_album.php" method="POST">
                                ...
                                <div class="mb-3">
                                  <label for="nama_album" class="form-label">Nama Album</label>
                                  <input type="text" name="nama_album" id="nama_album" value="<?php echo $data['nama_album'] ?>" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                  <label for="deskripsi" class="form-label">Deskripsi</label>
                                  <textarea name="deskripsi" id="deskripsi" class="form-control" rows="4" required><?php echo $data['deskripsi']; ?></textarea>
                                </div>
                      ...
                      <!-- Tombol Hapus -->
                      <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $data['id_album'] ?>">Hapus</button>
                      <!-- Modal Hapus -->
